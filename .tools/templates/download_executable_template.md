...
# ⬇️ Install FileSorter Locally

Choose your operating system and follow the instructions below to install FileSorter on your computer.
...
## 1. Click the button to download FileSorter executable

<a href="https://github.com/CTIU-Kuopio/CTIU_Tools/releases/download/0.0.1/FileSorter-0.0.1-Windows-x86_64.exe">
...
After installation, you can launch FileSorter from your desktop app or from the Start Menu:

![Launch FileSorter](https://github.com/CellMigrationLab/LabConstrictor/blob/doc_source/Windows_Launch.gif)
...
<a href="https://github.com/CTIU-Kuopio/CTIU_Tools/releases/download/0.0.1/FileSorter-0.0.1-Linux-x86_64.sh">
...
```bash
bash FileSorter-0.0.1-Linux-x86_64.sh
```
...
After installation, you can launch FileSorter from your applications menu and start using it following the instructions on the [Usage of Notebooks After Installation](./notebook_usage.md) guide.
...
<a href="https://github.com/CTIU-Kuopio/CTIU_Tools/releases/download/0.0.1/FileSorter-0.0.1-MacOSX-arm64.pkg">
...
<a href="https://github.com/CTIU-Kuopio/CTIU_Tools/releases/download/0.0.1/FileSorter-0.0.1-MacOSX-x86_64.pkg">
...
Double-click the downloaded file to start the installation process. It might give some errors, as shown bellow, go to `Settings > Privacy & Security > Security` and there the FileSorter package should appear. Click on `Open Anyway`.
...
After installation, you can launch FileSorter from your Applications folder and start using it following the instructions on the [Usage of Notebooks After Installation](./notebook_usage.md) guide.

</details>

---

# 🗑️ Uninstall FileSorter
...
![Uninstall FileSorter](https://github.com/CellMigrationLab/LabConstrictor/blob/doc_source/Windows_Uninstall.png)

or by directly going to `Settings` > `Apps` > `Installed apps`.

## 2. Uninstall FileSorter

Once there, search for `FileSorter` and click the three dots on the right and select `Uninstall`.
...
2.- Find FileSorter and delete it.

## 2. Uninstall FileSorter folder

1.- On the installation process, you chose a folder where you would install FileSorter. Find it.
2.- Delete that complete folder.

## 3. Check that the uninstallation has been correctly done

1.- Go to your `Trash` folder.
2.- Check that both FileSorter App and folder are there.
