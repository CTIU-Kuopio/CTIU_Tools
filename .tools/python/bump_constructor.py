...
def ensure_requirements_in_extra_files(construct_data: dict):
    ...
    if not requirements_included:
        extra_files.append({"requirements.txt": "FileSorter/requirements.txt"})
    ...
    if Path("requirements-linux.txt").exists():
        ...
        if not linux_included:
            extra_files.append({"requirements-linux.txt": "FileSorter/requirements-linux.txt"})
    ...
    if Path("requirements-windows.txt").exists():
        ...
        if not windows_included:
            extra_files.append({"requirements-windows.txt": "FileSorter/requirements-windows.txt"})
    ...
    if Path("requirements-macos.txt").exists():
        ...
        if not macos_included:
            extra_files.append({"requirements-macos.txt": "FileSorter/requirements-macos.txt"})
